...
use super::{BinomialBandit, EpsilonGreedyAgent, Game, HarmonicStepper, random_init};

pub fn epsilon_bernoulli(
    runs: u32,
    iterations: u32,
    agent_start: f64,
    epsilon: f64,
    ...
    let mut agent = EpsilonGreedyAgent::new(q_init, &mut stepper, epsilon);
